...
<body>
<h1 style="text-align: center; margin-top:100px; margin-bottom:50px">PROGRAM</h1>
    <div class="row row-cols-1 row-cols-md-2 g-4" style="margin-left:300px">
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              <h4 class="card-title text-center text-decoration-none"><a href="/program/karir">Karir</a> </h4>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              <h4 class="card-title text-center text-decoration-none"><a href="/program/magang">Magang</a></h4>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              <h4 class="card-title text-center text-decoration-none"><a href="/program/kunjungan-industri">Kunjungan Industri</a> </h4>
