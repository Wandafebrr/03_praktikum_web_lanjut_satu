...
<body>
<h1 style="text-align: center; margin-top:100px; margin-bottom:50px">PRODUCTS</h1>
    <div class="row row-cols-1 row-cols-md-2 g-4" style="margin:50px">
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              <h4 class="card-title text-center text-decoration-none"><a href="/product/furniture">Furniture</a> </h4>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              <h4 class="card-title text-center text-decoration-none"><a href="/product/electronics">Electronics</a></h4>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              <h4 class="card-title text-center text-decoration-none"><a href="/product/smartphone">Smartphone</a> </h4>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              <h4 class="card-title text-center "><a classs="text-decoration-none" href="/product/clothes">Clothes</a> </h4>
            </div>
          </div>
        </div>
      </div>
